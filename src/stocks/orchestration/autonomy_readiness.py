...
def build_autonomy_readiness(
    ...
    gates = {
        ...
        # Bound only in v2.8 after current IBKR reconciliation, integer sizing,
        # writer integrity and dedicated live authority are connected.
